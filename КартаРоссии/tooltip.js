var tooltip = {
	...
	l: function(o, e, a){
		if (o.addEventListener) o.addEventListener(e, a, false); // Opera 
	...
	a: function(x, y){
		...
		var w_height = window.innerHeight ? window.innerHeight + window.pageYOffset : tooltip.canvas.clientHeight + (tooltip.canvas.scrollTop || document.body.scrollTop); 
